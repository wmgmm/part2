...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        body:
          'Use Gemini, in a new chat, with the CSV attached again and Canvas on from the Tools menu. It works on Flash but Pro handles it better. The first build often takes a while or falls over. Just send it again.',
        promptLabel: 'THE BUILD PROMPT',
        attachLabel: 'IN THIS CHAT',
        attach: [A.hesaData],
        attachExtra: {
          src: 'canvas_button.webp',
          alt: 'The Canvas button in Gemini, a small grey chip reading Canvas.',
        },
        promptNote: '[new chat, Canvas on, and attach HESA_Estates_Workshop.csv again]',
        prompt:
