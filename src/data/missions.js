...

  {
    ...
    steps: [
      ...
      },
      {
        ...
        body:
          'Use Gemini for this one. Start a new chat, attach the CSV again, then open the Tools menu under the box where you type and select Canvas. The first build often takes a while or falls over. If it does, just send it again.',
        promptLabel: 'THE BUILD PROMPT',
        promptNote: '[new chat, Canvas on, and attach HESA_Estates_Workshop.csv again]',
        prompt:
          'Act as a front-end developer and data visualisation expert.\n\nBuild a self-contained interactive dashboard in ONE HTML file using inline CSS, JavaScript and Chart.js from a CDN. It must run standalone in Gemini Canvas.\n\nTOPIC: Cardiff University\'s estates, energy and emissions performance versus the UK higher education sector using HESA Estates data (2015/16-2024/25).\n\nUse only figures provided or calculated in this chat. Do not invent, estimate or extend data. If a value is unavailable, display NEEDS DATA.\n\nOutput in four stages:\n1. SPEC (max 150 words)\n2. PLAN\n3. COMPLETE HTML FILE\n4. SELF-CHECK\n\nThe centrepiece must be an animated bubble chart:\n- One bubble per university\n- Cardiff University highlighted\n- X-axis = Energy intensity (kWh/m²)\n- Y-axis = Emissions intensity (kgCO₂e/m²)\n- Bubble size = Floor area (m²)\n- Play, pause and year slider\n- Smooth animation from 2015/16 to 2024/25\n- Tooltip showing university name and metrics\n- Trail showing Cardiff\'s movement through time\n\nInclude:\n- Headline KPI cards\n- Cardiff\'s sector ranking and percentile position\n- Year-on-year changes\n- Interactive filters\n- A "What Changed?" panel explaining Cardiff\'s movement since the previous year in plain English\n- A key insights panel highlighting notable universities and trends\n- A verification panel\n\nVerification panel:\nPick the single most important number on the page and show:\n- source values\n- formula\n- arithmetic\n- final result\n- Excel formula\n- one limitation\n\nStyle:\n- White background\n- One accent colour\n- High contrast\n- UK English\n- Responsive for projector and laptop screens\n- Legends outside charts where needed\n- Every axis labelled with units\n\nSelf-check:\nConfirm every figure traces to the supplied data, all controls work, derived values are calculated rather than hard-coded, and no data has been invented.\n\nMake the dashboard tell a story, not just show charts. The main question should be:\n"Has Cardiff University become more energy efficient and less carbon intensive relative to the sector over the last decade?"',
      },
    ],
    verdictBy: 'The Matts',
    verdict:
