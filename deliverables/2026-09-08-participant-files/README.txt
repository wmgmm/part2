AI in the Workplace, Part 2: participant files
Website: https://wmgmm.github.io/part2/

Every file here is also on the website, on its exercise page. This folder is
the offline copy. Workshop_Hint_Sheets.pdf is one page per exercise.

Exercise_01  Sustainable-Futures-en.pdf (the plan), Deep_research_output.pdf (backup report)
