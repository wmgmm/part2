...
Core step time: 01 is 10 minutes, 02 is 12, 03 is 11, 04 is 12, 05 is 15, 06 is 20. Eighty minutes for all six, so nobody does all six. The pages were cut back hard on 2026-09-04 to read as goal-then-steps, so there is far less to read and more time to do.
