...
- `Cardiff_House_Style.md` - V1-V6 voice rules and D1-D8 design rules, measured out of Cardiff's own PowerPoint template. Generation only: it builds, it does not review, and it hands back a note of any rule it could not apply. Used inside Exercise 05's Slide Deck step. The evidence is in `docs/research/2026-09-04-cardiff-template-design-system.md`.
